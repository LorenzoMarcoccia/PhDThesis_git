...
\begin{table}[]
	\centering
	\tiny
	\input{Appendices/AP8/figures/SPLUSB_CRSR_UsingSMTFullSys/Tables/Yields_clean}
...
\begin{table}[]
	\centering
	\tiny
	\input{Appendices/AP8/figures/SPLUSB_CRSR_UsingSMTFullSys/Tables/Yields_postFit}
