...
% ----------------------- name of chapter  -------------------------
\newgeometry{top=0.2cm, left=1.2cm, right=1.5cm, bottom=1.45cm}
...
is \SI{0.93\pm0.25}{}, compatible with unity. Also, the \VVHF
...
\begin{table}[]
	\footnotesize
	\centering
	\input{Chapters/CH7/figures/BONLY_CR_UsingDL1rcFullSys/Tables/Yields_clean}
...
\begin{table}[]
	\footnotesize
	\centering
	\input{Chapters/CH7/figures/BONLY_CR_UsingDL1rcFullSys/Tables/Yields_postFit_clean}
