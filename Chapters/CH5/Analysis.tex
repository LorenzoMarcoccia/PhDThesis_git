...
The values are: 
\begin{itemize}
	\item for the FCNC top, $m_{t_{\mathrm{FCNC}}}=171.2$~\GeV and $\sigma_{t_{\mathrm{FCNC}}}=11.4$~\GeV;
	\item for the SM top, $m_{t_{\mathrm{SM}}}=168.0$~\GeV and $\sigma_{t_{\mathrm{SM}}}=23.9$~\GeV;
	\item for the \PW boson, $m_W=82.6$~\GeV and $\sigma_W=16.6$~\GeV.
\end{itemize}	
