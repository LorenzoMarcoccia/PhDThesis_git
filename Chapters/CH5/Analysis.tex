...
The description of the SR3 selections is reported in \Cref{sec:selection}.
The description of the other SRs selections is reported in \Cref{sec:other_selection}.
...
The electron triggers select a calorimeter cluster matched to a track.
