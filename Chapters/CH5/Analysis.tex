...
The branching ratio is setted to \mbox{BR($t\rightarrow cZ$) = $2.4\times10^{-4}$}, constraining\\ \mbox{BR($t\rightarrow bW$) = 1 - BR($t\rightarrow cZ$)}, which is the observed limit obtained from
