...
%The Var3c A14 tune variation corresponds
...
using the A14 tune~\cite{ATL-PHYS-PUB-2014-021} and the
\\ \textsc{NNPDF2.3LO}~\cite{Ball:2014uwa} PDF set. For all the samples, except those simulated with \sherpa, the decays of bottom and charm hadrons
