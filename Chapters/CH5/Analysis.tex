...
The description of the other SRs selections, used for the combined fit to extract expected limits, are reported in \Cref{sec:selection_dl1rc}.\\
...
which corresponds to more signal events and 10\% background events of the whole SR3\tZc with SMT. The GBDT output for SMT is presented in \Cref{sec:separation} while for \DLrc it will be presented in \Cref{sec:separation_dl1r}.
\begin{figure}[!htbp]
	\centering
	\subfigure[SMT selection]{
		\includegraphics[width=.9\textwidth]{Chapters/CH5/figures/GBDT_smt}
		\label{fig:yields:sr3_smt_bdt}} \qquad
	\subfigure[\DLrc selection]{
		\includegraphics[width=.9\textwidth]{Chapters/CH5/figures/GBDT_dl1rc}
