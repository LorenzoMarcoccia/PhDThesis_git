...
\begin{figure}[!h]
	\centering	
	\subfigure[] {\label{fig:strips_eta}\includegraphics[width=0.85 \textwidth]{Chapters/CH3/figures/clusterSize_BI_stripCenterEta}} 
	\subfigure[] {\label{fig:strips_phi}\includegraphics[width=0.85 \textwidth]{Chapters/CH3/figures/clusterSize_BI_stripCenterPhi}} 
...
\begin{figure}[!h]
	\centering	
	\subfigure[] {\label{fig:CS_eta}\includegraphics[width=0.9 \textwidth]{Chapters/CH3/figures/stripEta_BI}\label{fig:NstripEta_BI}} 
	\subfigure[] {\label{fig:CS_phi}\includegraphics[width=0.9 \textwidth]{Chapters/CH3/figures/stripPhi_BI}\label{fig:NstripPhi_BI}} 
	\caption{Number of \subref{fig:NstripEta_BI} $\eta$ and \subref{fig:NstripPhi_BI} $\phi$ strips switched on for different chambers:  BIS in red, BIL in blue, BIR \& BIM in green.}
	\label{fig:strips_BI}
\end{figure}	
\FloatBarrier
...
\begin{figure}[h]
	\centering
	\subfigure [3/3 chamber]{{\label{fig:allcasesBMBO_a}}\includegraphics[width=0.95 \textwidth]{Chapters/CH3/figures/BMBO_firstCase}} 
\end{figure}	
\begin{figure}[h]
	\centering
	\subfigure [3/4 chambers]{{\label{fig:allcasesBMBO_b}}\includegraphics[width=0.95 \textwidth]{Chapters/CH3/figures/BIBM_firstCase}} 
	\subfigure [3/4 chambers + BIBO]{{\label{fig:allcasesBMBO_c}}\includegraphics[width=0.95 \textwidth]{Chapters/CH3/figures/BIBO_firstCase}} 
