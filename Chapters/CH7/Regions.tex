...
% ----------------------------------------------------------------------
This chapter presents the Signal Regions dedicated to FCNC \tZc in \ttbar decays and single-top production using a veto on \Pqc-tagged jets.
...
the corresponding decay particles using~\Cref{eq:chi2tt} in~\Cref{sec:sel:topmassrec} as well more other details about the top quarks reconstruction for the FCNC \ttbar decay.\\
...
\begin{figure}[!htbp]
	\centering
	\subfigure[]{\includegraphics[width=.47\textwidth]{Chapters/CH7/figures/cveto_bdt/GBDT_signal}\label{subfig:separation:GBDTsig_dl1rc}}\qquad
	\subfigure[]{\includegraphics[width=.47\textwidth]{Chapters/CH7/figures/cveto_bdt/GBDT_background}\label{subfig:separation:GBDTbkg_dl1rc}}
	\caption{ The GBDT output score distributions for \subref{subfig:separation:GBDTsig_dl1rc} signal events and \subref{subfig:separation:GBDTbkg_dl1rc} background events, in the test samples. Trained five GBDTs are compared in each signal region. }
