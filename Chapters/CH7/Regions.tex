...
\Cref{chapter:charm_tag} described the event selection targeting the FCNC \ttbar decay process using a charm-tagger. To extract limits on the FCNC \tZc coupling, two addition channels can be investigated: FCNC \ttbar decays without the use of a charm-tagger and FCNC single top production.\\
