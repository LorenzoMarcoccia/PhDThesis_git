...
There are many are models of "new physics" that attempt to describe and explain these phenomena.
...
FCNC decays occur at one-loop level but are strongly suppressed by the GIM mechanism \cite{gim}, with a suppression factor of 14 orders of magnitude relative to the dominant decay mode.
