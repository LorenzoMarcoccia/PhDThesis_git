...
\end{itemize}
The fake normalization factor $\mu_{\ttbar+\Wt}$ (\Cref{fig:stat:tzc:splusb:crsr:norm_unb}) is compatible with unity.\\
...
From the likelihood fit described in \Cref{sec:stat:tzc:unb} under the Background-only hypothesis no evidence for the FCNC $\mathrm{\Pqt\rightarrow\PZ\Pqc}$ signal is found but a good agreement between data and Standard Model is observed.
