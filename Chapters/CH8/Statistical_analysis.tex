...
In Table \ref{tab:limits:comparison} is also possible to estimate the impact of the \Pqc-tagging using \DLrc or SMT (presented in \Cref{app:stat_smt:tzc:splusb:crsr}) on the analysis comparing the results without using none of these techniques (called 'Baseline').\\
