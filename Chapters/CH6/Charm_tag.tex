...
Since a semi-leptonic decay can be originated from a C-hadron decay but also from a B-hadrons decay (see \Cref{sec:smt_compositions}), the SMT-jet can be associated to the FCNC top decay or to the SM top decay, depending on the minimum $\chi^2$.
