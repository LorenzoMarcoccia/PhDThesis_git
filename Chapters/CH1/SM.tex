...
The only states that occur are completely antisymmetric in the colour variables (the colour singlets), which is equivalent to saying that the possible compositions of quarks must be "white".\\
...
The GIM hypothesis represent a generalization of Cabibbo's idea. The introduction of the fourth quark (c) restored the symmetry
...
Since the top quark mass is higher than the W boson mass, it decays through weak interaction, mainly in $t\rightarrow W^{+}b$; according to SM is 100\% of the possible cases.\\
...
of $t\bar{t}$ decays: dileptonic, semi-leptonic or hadronic.\\ Figure~\ref{fig:ttBR} summarize the BRs associated to each channel.\\
