...
\item The problem of \textit{naturalness} is also much debated in literature. The Higgs boson is very sensitive to loop corrections (involving top quark and itself
mainly) and if one considers the theory close to the Planck scale, these corrections may not explain why the Higgs boson mass is so relatively small compared
