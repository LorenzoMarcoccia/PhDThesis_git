...
\include{Appendices/AP7/BONLY}
\bookmarksetupnext{level=-8}
\include{Appendices/AP9/SPLUSB_baseline}
\bookmarksetupnext{level=-9}
\include{Appendices/AP8/SPLUSB_smt}
\bookmarksetupnext{level=-10}
\include{Appendices/AP10/B_only_unb}
\bookmarksetupnext{level=-11}
\end{appendices}
%\addtocontents{toc}{\protect\vskip30pt}
